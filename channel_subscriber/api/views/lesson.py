...
class LessonViewSet(GenericViewSet, ListModelMixin, CreateModelMixin, RetrieveModelMixin, UpdateModelMixin, DestroyModelMixin):
    ...
    def get_queryset(self):
        return Lesson.objects.get_lessons_with_relateds().all()
    ...
    def list(self, request, *args, **kwargs):
        ...
        if teacher or user.is_staff == True:  
            ...
            return Response({"Error": 'You can not see the lessons only teacher can'}, status=status.HTTP_403_FORBIDDEN)
    ...
    def retrieve(self, request, *args, **kwargs):
        ...
        if teacher or user.is_staff == True:  
            ...
            return Response({"Error": 'You can not see a specific lesson only teacher can'}, status=status.HTTP_403_FORBIDDEN)
